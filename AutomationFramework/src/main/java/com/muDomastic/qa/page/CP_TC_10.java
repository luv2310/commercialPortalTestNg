...
public class CP_TC_10  {
	...
	public void TC_10_TS_10_phase2()
	{
		try {
			...
			System.out.println(action.verifyElementPresent(uploadContract)+"::");
			System.out.println(action.verifyElementPresentviaXpath("//div[@class=\"file-upload btn-block\"]"));
			action.clickWithAttempt(uploadContract);
			uploadContract.sendKeys(System.getProperty("user.dir")+"\\drive\\contract.pdf");
